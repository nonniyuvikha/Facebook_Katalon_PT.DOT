...
LoginSuccess
    ...
    Press Key                                     //div[@role="textbox"]                                 CONTROL+A+BACKSPACE
...
CreateEditDeletePost
    ...
    Wait Until Element Is Visible                 //div[@aria-label="Create a post"]                              timeout=30s
    Click Element                                 //span[contains(.,"What's on your mind, Kara?")]
    Wait Until Element Is Visible                 //div[@aria-label="Create post"]                                timeout=30
    ...
    Click Element                                 //div[@aria-label="What's on your mind, Kara?"]
    #Press Key                                     //div[@aria-label="What's on your mind, Kara?"]                CONTROL+A+BACKSPACE
